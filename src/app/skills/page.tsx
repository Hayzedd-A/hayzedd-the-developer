...
import { experienceYear } from "@/lib/utils";
...
const skills: Skill[] = [
  {
    ...
    experience: experienceYear(2020),
    projects: 30,
  },
  {
    id: "13",
  ...
  },
  {
    ...
    experience: experienceYear(2023),
    projects: 15,
  },
  {
    id: "14",
  ...
  },
  {
    ...
    experience: experienceYear(2021),
    projects: 6,
  },
  {
    id: "1",
    ...
    experience: experienceYear(2022),
    projects: 15,
  },
  {
    id: "2",
...
export default function SkillsPage() {
  ...
  const SkillCard = ({ skill, index }: { skill: Skill; index: number }) => (
    ...
    >
      ...
      <div
        className={`p-6 ${viewMode === "list" ? "flex items-center space-x-4" : ""}`}
      >
        {/* Skill Icon */}
        <div
          className={`
        ...
        <div className={`${viewMode === "list" ? "flex-1" : ""}`}>
          ...
          {/* Stats */}
          <div
            className={`${viewMode === "list" ? "flex items-center gap-6" : "space-y-2"}`}
          >
