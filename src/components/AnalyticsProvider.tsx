  ...
  useEffect(() => {
    const fetchGitHubData = async () => {
      try {
        ...
        const [user, repos, languages, topRepos, contributions] = await Promise.all([
              ...
              <div className='flex items-start justify-between'>
                <div className='flex-1'>
                  ...
                  <p className='text-gray-600 dark:text-gray-400 mb-4'>
                    I use privacy-friendly analytics to understand how visitors interact with my
                    site. This helps me improve the user experience. No personal data is collected
                  ...
                  <div className='flex flex-col sm:flex-row gap-3'>
                    ...
                    <button
                      // record that user declined analytics
